...
OUTPUT_ARCH(hexagon)
PLUGIN_ITER_SECTIONS("findalluseshelloworld", "FINDHELLOWORLDUSES")
ENTRY(start)
SECTIONS
{
  /* Code starts. */
  ...
  // The plugin will run on this output section block.
  .compress :
  {
    *main.o(.compress*)
  ...
  // The address of this section will remain unchanged even after
  // the block above has been compressed
  .marker :
  {
    *(.text.foo)
    *(.text.bar)
