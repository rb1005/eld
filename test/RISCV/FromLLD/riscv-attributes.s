...
# RUN: %link %linkopts -e 0 unrecognized_ext1.o -o unrecognized_ext1 2>&1
...
# RUN: %link %linkopts -e 0 unrecognized_ext2.o -o unrecognized_ext2 2>&1
...
# RUN: %link %linkopts -e 0 unrecognized_version.o -o unrecognized_version 2>&1
...
# RUN: %link %linkopts -e 0 unrecognized_version.o merge_version_test_input.o -o out3 2>&1
...
# RUN: %link %linkopts -e 0 --fatal-warnings a.o unaligned_access_0.o -o unaligned_access_0
...
# RUN: not %link %linkopts a.o b.o c.o diff_stack_align.o -o /dev/null 2>&1 | FileCheck %s --check-prefix=STACK_ALIGN --implicit-check-not=error:
# STACK_ALIGN: Reading incompatible attributes in file diff_stack_align.o, Error mixing attribute STACK_ALIGN, seen previous value 16 from input file c.o, now seen 32
...
# RUN: %link %linkopts -e 0  a.o b.o c.o diff_priv_spec.o -o diff_priv_spec
...
# HDR:      LOAD           0x000000 0x0000000000000000 0x0000000000000000 0x0000b0 0x0000b0 R E  0x1000
