...
RISCVRelocationMap RISCVRelocs = {
    ...
    {eld::ELF::R_RISCV_RVC_LUI,
     {/*.Name = */ "R_RISCV_RVC_LUI",
      /*.Type = */ eld::ELF::R_RISCV_RVC_LUI,
      ...
      /*.Signed = */ true,
      /*.Size = */ 16}},
    {eld::ELF::R_RISCV_GPREL_I,
     {/*.Name = */ "R_RISCV_GPREL_I",
      /*.Type = */ eld::ELF::R_RISCV_GPREL_I,
      /*EncodingType = */ EncTy_I,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      ...
      /*.Signed = */ true,
      /*.Size = */ 32}},
    {eld::ELF::R_RISCV_GPREL_S,
     {/*.Name = */ "R_RISCV_GPREL_S",
      /*.Type = */ eld::ELF::R_RISCV_GPREL_S,
      /*EncodingType = */ EncTy_S,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      ...
      /*.Signed = */ true,
      /*.Size = */ 32}},
    {eld::ELF::R_RISCV_TPREL_I,
     {/*.Name = */ "R_RISCV_TPREL_I",
      /*.Type = */ eld::ELF::R_RISCV_TPREL_I,
      /*EncodingType = */ EncTy_I,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      ...
      /*.Signed = */ true,
      /*.Size = */ 32}},
    {eld::ELF::R_RISCV_TPREL_S,
     {/*.Name = */ "R_RISCV_TPREL_S",
      /*.Type = */ eld::ELF::R_RISCV_TPREL_S,
      /*EncodingType = */ EncTy_S,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
